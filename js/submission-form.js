...
export function openSubmissionForm({
  ...
  <style>
    *{box-sizing:border-box;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}body{margin:0;background:#edf3ef;color:#0d4778;font:14px Arial,sans-serif}.toolbar{position:sticky;top:0;display:flex;justify-content:center;gap:10px;padding:12px;background:#0d4778}.toolbar button{padding:10px 16px;border:0;border-radius:7px;font-weight:700;cursor:pointer}.save{background:#f4c430;color:#0d4778}.print{background:#fff;color:#0d4778}.sheet{position:relative;width:210mm;min-height:297mm;margin:18px auto;padding:0 12mm 25mm;background:#fff;box-shadow:0 8px 30px #0002}.official-header{display:block;width:calc(100% + 24mm);height:auto;margin:0 -12mm 10mm}.official-footer{position:absolute;left:12mm;right:12mm;bottom:7mm;width:calc(100% - 24mm);height:auto}.form-title{text-align:center;margin:18px 0}.form-title h2{margin:0 0 6px;text-transform:uppercase}.form-title p{margin:0}.content{display:grid;grid-template-columns:1fr 36mm;gap:18px}.fields{display:grid;grid-template-columns:1fr 1fr;border-top:1px solid #bccbc3;border-left:1px solid #bccbc3}.field{min-height:58px;padding:9px;border-right:1px solid #bccbc3;border-bottom:1px solid #bccbc3}.field span{display:block;margin-bottom:7px;color:#60746a;font-size:11px;font-weight:700;text-transform:uppercase}.field strong{white-space:pre-wrap}.photo{width:36mm;height:36mm;border:1px solid #174f86;display:flex;align-items:center;justify-content:center;text-align:center;color:#71847b;overflow:hidden}.photo img{width:100%;height:100%;object-fit:cover}.cert{margin-top:28px;padding-top:14px;border-top:1px solid #bccbc3;font-size:12px;line-height:1.6}.signatures{display:grid;grid-template-columns:1fr 1fr;gap:50px;margin-top:55px;text-align:center}.line{padding-top:7px;border-top:1px solid #0d4778}.hint{text-align:center;margin:20px 0;color:#64748b;font-size:12px}
    .identity-assets{display:flex;flex-direction:column;gap:12px}.form-qr{display:flex;width:36mm;flex-direction:column;align-items:center;gap:4px;padding:5px;border:1px solid #174f86;color:#0d4778;font-size:7px;font-weight:700;text-align:center}.form-qr img{width:30mm;height:30mm;object-fit:contain}
  ...
  <main class="sheet"><img class="official-header" src="${escapeHtml(headerUrl)}" alt="Tricycle Franchising and Regulatory Office official header">
  ...
  <img class="official-footer" src="${escapeHtml(footerUrl)}" alt="TFRO official footer"><p class="hint">Use “Save as PDF” and choose the PDF destination in the print dialog.</p></main></body></html>`);
...
export function openRenewalProfileForm({
  ...
  const cityLogo = new URL("../Logo/Lucena City Logo.png", window.location.href)
    .href;
  const tfro005Header = new URL(
    "../Logo/TFRO-005 Header.png",
  ...
  const tfro005ReferenceTheme = `
    .sheet{position:relative!important;width:8.5in!important;min-height:13in!important;padding:6mm 13mm 5mm!important;border:0!important;box-shadow:0 6px 24px #0002!important;font:10pt Calibri,Arial,sans-serif!important}
    .sheet:before{content:"";position:absolute;inset:6mm 13mm 5mm;z-index:0;border:1.5px solid #111;pointer-events:none}.sheet>*{position:relative;z-index:1}
    .masthead{height:20mm!important;border:0!important;margin:0!important;background:url("${escapeHtml(tfro005Header)}") center/100% 100% no-repeat!important}.masthead .office,.masthead .logos{display:none!important}
    .hotline{position:relative!important;height:9mm!important;border:0!important;padding:0!important;background:#fff!important;font-size:0!important}.form-code{position:absolute!important;top:1.5mm!important;right:1.5mm!important;width:44mm!important;margin:0!important;padding:1.7mm 3mm!important;background:#5486be!important;color:#050505!important;font:700 10pt "Book Antiqua",Georgia,serif!important;letter-spacing:1px!important}
    .title-grid{height:18mm!important;margin-top:0!important;border:1.25px solid #111!important;grid-template-columns:1fr 64mm!important;overflow:hidden!important}.title{display:flex!important;align-items:center!important;justify-content:center!important;background:#000!important;color:#fff!important;font:700 italic 13pt "Book Antiqua",Georgia,serif!important;line-height:1.15!important}.meta{grid-template-columns:19mm minmax(0,1fr)!important;grid-template-rows:repeat(2,minmax(0,1fr))!important;min-width:0!important}.meta b,.meta span{display:flex!important;align-items:center!important;min-width:0!important;overflow:hidden!important;padding:1px 2px!important;border-left:1.25px solid #111!important;border-bottom:1.25px solid #111!important;font-size:7pt!important;line-height:1!important;white-space:nowrap!important}.meta .type-label{grid-row:2}.meta .type-value{grid-row:2}.meta .franchise-label{grid-row:2;grid-column:3}.meta .franchise-value{grid-row:2;grid-column:4}.meta{grid-template-columns:19mm 19mm 25mm minmax(0,1fr)!important}.meta .date-value{grid-column:2/5!important}
    .app-grid{height:34mm!important;grid-template-columns:1fr 46mm!important;grid-template-rows:16mm 18mm!important;border-top:0!important}.app-grid .contact{grid-column:2!important;grid-row:1!important}.app-grid .address{grid-column:1/-1!important;grid-row:2!important}.line-field{position:relative!important;min-height:0!important;padding:1.2mm 1mm!important}.line-field b{font-size:10pt!important;line-height:1!important}.line-field span{margin-top:1mm!important;font-size:9pt!important}.field-sublabels{position:absolute;left:0;right:0;bottom:0;display:grid;border-top:1px solid #111;font-size:7pt;font-weight:700}.name-sublabels{grid-template-columns:1fr 1fr 1fr}.address-sublabels{grid-template-columns:1.1fr .9fr}.field-sublabels i{padding:.4mm 1mm;font-style:normal;text-align:center}
    .four{height:13mm!important}.four .line-field{height:13mm!important;padding:1.5mm 1mm!important}.vehicle-head{height:5mm!important;padding:.8mm!important;font-size:9pt!important}.vehicle{height:32mm!important;grid-template-rows:repeat(4,8mm)!important}.vehicle .line-field{padding:1mm!important}.vehicle .line-field span{margin-top:.5mm!important}.route{height:17mm!important;grid-template-columns:1fr 39mm!important;background:#000!important;color:#fff!important}.route div{display:flex!important;align-items:flex-end!important;padding:1mm!important}.route b{font-size:9pt!important}.route-name{align-items:center!important;justify-content:center!important;background:#fff!important;color:#111!important;border-left:0!important;font-size:9pt!important}
    .profile-body{height:72mm!important;grid-template-columns:1fr 40mm!important;grid-template-rows:31mm 41mm!important}.cert{position:relative!important;padding:5mm 10mm 2mm!important;font-size:9pt!important;font-weight:700!important;line-height:1.35!important;text-indent:8mm!important}.signature-box{grid-column:2!important;grid-row:1!important;border-left:1.25px solid #111!important;display:flex!important;align-items:flex-end!important;justify-content:center!important;padding:1mm!important;text-align:center!important;font-size:7pt!important;font-weight:700!important}.requirements{grid-column:1/-1!important;grid-row:2!important;position:relative!important;counter-reset:requirement;padding:2mm 45mm 1mm 0!important;border-top:1.25px solid #111!important}.requirements h3{font-size:10pt!important;margin-bottom:.5mm!important}.requirement{font-size:9pt!important;line-height:1.3!important}.requirement:before{counter-increment:requirement;content:counter(requirement) ". ";}.requirement .check{display:none!important}.photo{grid-column:2!important;grid-row:2!important;align-self:start!important;width:40mm!important;height:37mm!important;min-height:0!important;margin:2mm 0 0!important;border:1.5px solid #111!important;font-size:10pt!important}
    .office-head{height:10mm!important;border:0!important;border-top:1px dashed #555!important;background:#fff!important;color:#111!important;font:700 12pt "Times New Roman",serif!important;padding:4mm 0 0!important}.inspection{height:41mm!important;border:0!important;display:grid!important;grid-template-columns:1fr 1fr 38mm!important;grid-template-rows:31mm 10mm!important}.inspect-column{border:0!important;padding:.5mm 3mm 0 0!important}.inspect-row{display:grid;grid-template-columns:40mm 17mm 1fr;align-items:center;min-height:4.6mm;font-size:9pt}.inspect-row b{font-size:9pt}.inspect-line{display:block;border-bottom:1px solid #111;text-align:center;min-height:3mm}.inspector{grid-column:3!important;grid-row:1/3!important;padding:.5mm 0!important;font-size:9pt!important}.inspector-line{margin-top:8mm!important;font-size:8pt!important}.sidecar{grid-column:1/3!important;grid-row:2!important;border:0!important;padding:.5mm 0!important;font-size:9pt!important}.sidecar .inspect-line{display:inline-block;width:33mm;margin-left:10mm}.approvals{height:30mm!important;border:0!important;gap:25mm!important;padding:4mm 47mm 0!important}.approval-line{border:0!important;font-size:9pt!important}.approval-label{display:block;margin-bottom:5mm;font-weight:400!important}.footer{height:14mm!important;border:0!important;margin:0!important;padding:0!important;background:url("${escapeHtml(tfro005Footer)}") center/100% 100% no-repeat!important;color:transparent!important;font-size:0!important}
    @media print{.sheet{display:block!important;width:8.5in!important;height:13in!important;min-height:13in!important;margin:0!important;padding:6mm 13mm 5mm!important;overflow:hidden!important;box-shadow:none!important}.sheet:before{inset:6mm 13mm 5mm}.masthead,.hotline,.title-grid,.app-grid,.four,.vehicle-head,.vehicle,.route,.profile-body,.office-head,.inspection,.approvals,.footer{margin-left:0!important;margin-right:0!important}.hint{display:none!important}}
  `;

  popup.document
    .write(`<!doctype html><html><head><meta charset="utf-8"><title>${escapeHtml(filename)}</title><style>
  *{box-sizing:border-box}body{margin:0;background:#e9efec;color:#050505;font:9px Arial,sans-serif}.toolbar{position:sticky;top:0;z-index:2;display:flex;justify-content:center;gap:10px;padding:10px;background:#0d4778}.toolbar button{padding:9px 15px;border:0;border-radius:6px;font-weight:700;cursor:pointer}.save{background:#f3d72f}.print{background:#fff}.sheet{width:210mm;min-height:297mm;margin:14px auto;background:#fff;padding:5mm;box-shadow:0 6px 24px #0002}.masthead{height:21mm;border:1.25px solid #111;display:flex;align-items:center;background:linear-gradient(120deg,#0d4778 0 59%,#f0dc29 59% 65%,#fff 65% 68%,#174f86 68% 73%,#fff 73% 76%,#e9dc24 76% 81%,#fff 81%)}.masthead .office{padding:3mm;color:#fff;flex:1}.office h1{font-size:13px;margin:0;color:#fff}.office p{margin:2px 0}.logos{display:flex;gap:6px;padding:4px 8px;background:#fff}.logos img{width:14mm;height:14mm;object-fit:contain}.hotline{height:6mm;border:1.25px solid #111;border-top:0;padding:2px 6px;background:#f5e92d;font-size:7px}.form-code{float:right;min-width:42mm;margin:-2px -6px 0 0;background:#075373;color:#fff;padding:4px 18px;text-align:center;font-weight:bold}.title-grid{clear:both;display:grid;grid-template-columns:1fr 46mm;border:1.25px solid #111;border-top:0}.title{background:#050505;color:#fff;text-align:center;padding:6px;font:bold italic 12px Georgia,serif}.meta{display:grid;grid-template-columns:17mm 1fr}.meta b,.meta span{padding:2px;border-left:1px solid #111;border-bottom:1px solid #111;font-size:7px}.meta :nth-last-child(-n+2){border-bottom:0}.grid{display:grid;border-left:1.25px solid #111;border-top:1.25px solid #111}.app-grid{grid-template-columns:1fr 46mm}.line-field{min-height:8mm;padding:2px 4px;border-right:1.25px solid #111;border-bottom:1.25px solid #111}.line-field b{display:block;font-size:6.5px;text-transform:uppercase}.line-field span{display:block;margin-top:3px;font-weight:700;font-size:9px}.name-values{display:grid!important;grid-template-columns:1fr 1fr 1fr;margin:2px -4px -2px!important}.name-values i{min-height:4mm;padding:1px 4px;border-right:1px solid #bbb;text-align:center;font-style:normal;font-weight:700}.name-labels{display:grid;grid-template-columns:1fr 1fr 1fr;margin:2px -4px -2px;color:#444;font-size:5.5px;text-align:center}.full{grid-column:1/-1}.four{display:grid;grid-template-columns:1.4fr 1.5fr .45fr .9fr}.vehicle-head,.office-head{background:#050505;color:#fff;text-align:center;padding:3px;font-weight:bold;border:1.25px solid #111;border-top:0}.vehicle{grid-template-columns:1fr 1fr}.route{display:grid;grid-template-columns:1fr 38mm;border:1.25px solid #111;border-top:0}.route div{padding:4px}.route b{font-size:7px}.route-name{border-left:1.25px solid #111;text-align:center;font-weight:bold}.profile-body{display:grid;grid-template-columns:1fr 38mm;border:1.25px solid #111;border-top:0}.cert{padding:5px;line-height:1.35;text-align:justify}.signature{margin:8px 5px 0 55%;border-top:1px solid #111;text-align:center;padding-top:1px;font-size:6px}.photo{grid-column:2;grid-row:1/3;min-height:50mm;border-left:1.25px solid #111;display:flex;align-items:center;justify-content:center;text-align:center;font-weight:bold;overflow:hidden}.photo img{width:100%;height:100%;object-fit:cover}.requirements{padding:3px 5px;border-top:1.25px solid #111}.requirements h3{margin:0 0 2px;font-size:7px}.requirement{display:flex;gap:4px;align-items:center;line-height:1.4}.check{display:inline-flex;width:8px;height:8px;border:1px solid #111;align-items:center;justify-content:center;font-weight:bold}.office-head{text-align:left;padding-left:7px}.inspection{display:grid;grid-template-columns:1fr 1fr 1fr;border:1.25px solid #111;border-top:0}.inspect-column{padding:3px;border-right:1px solid #aaa}.inspect-item{display:flex;justify-content:space-between;min-height:4mm;border-bottom:1px solid #bbb;padding:1px 4px}.inspector{grid-column:3;grid-row:1/3;padding:5px;text-align:center}.inspector-line{margin-top:13px;border-top:1px solid #111;padding-top:2px;font-size:6px}.sidecar{grid-column:1/3;border-top:1px solid #111;padding:3px;min-height:10mm}.approvals{display:grid;grid-template-columns:1fr 1fr;gap:24mm;padding:11mm 11mm 3mm;text-align:center;border:1.25px solid #111;border-top:0}.approval-line{border-top:1px solid #111;padding-top:2px}.footer{text-align:center;font-size:6px;padding-top:2px}.hint{text-align:center;color:#64748b}.muted{font-weight:normal!important;color:#333}@page{size:A4;margin:0}@media print{body{background:#fff}.toolbar,.hint{display:none}.sheet{margin:0;box-shadow:none;width:210mm;min-height:297mm}}
  </style><style>
  ...
  <section class="title-grid"><div class="title">Application for MOTORIZED TRICYCLE OPERATOR<br>PERMIT</div><div class="meta"><b>DATE:</b><span class="date-value">${formatFormDate(renewal.created_at)}</span><b class="type-label">RENEWAL</b><span class="type-value">${escapeHtml(purpose)}</span><b class="franchise-label">FRANCHISE NO.</b><span class="franchise-value">${valueOrBlank(franchise.franchise_number)}</span></div></section>
  <section class="grid app-grid"><div class="line-field"><b>Name of Applicant</b><span class="name-values"><i>${valueOrBlank(lastName)}</i><i>${valueOrBlank(firstName)}</i><i>${valueOrBlank(middleName)}</i></span><small class="field-sublabels name-sublabels"><i>Last Name</i><i>First Name</i><i>Middle Name</i></small></div>${line("Contact Number", renewal.operator_contact, "contact")}<div class="line-field address"><b>Residential Address</b><span>${valueOrBlank(renewal.operator_address)}</span><small class="field-sublabels address-sublabels"><i>Home No. &amp; Street</i><i>Barangay</i></small></div></section>
  ...
  <section class="profile-body"><div class="cert">I hereby certify the correctness of the foregoing information, I am fully aware that the franchise permit which may be issued is subject to all requirements of existing ordinances including all rules and regulations promulgated by competent authorities of the City of Lucena.</div><div class="signature-box">Signature or RIGHT THUMBMARK of Applicant</div><section class="requirements"><h3>REQUIREMENTS:</h3>${requirement("Voter's Certificate/Voter's ID/ Any government issued ID", "voters_certificate")}${requirement("Barangay Clearance", "barangay_clearance")}${requirement("Community Tax Certificate (Cedula)", "cedula")}${requirement("Latest Registration OR/CR-xerox copy for verification with the original", "certificate_registration")}${requirement("Tricycle unit for Inspection", "official_receipt")}${requirement("Police Clearance (For New Applicant)", "pmbl_certification")}</section><div class="photo">${pictureUrl ? `<img src="${escapeHtml(pictureUrl)}" alt="2x2 picture">` : "2×2 PICTURE"}</div></section>
  <div class="office-head">DO NOT WRITE ANYTHING (FOR TFRO USE ONLY)</div><section class="inspection"><div class="inspect-column"><div class="inspect-row"><b>TAIL LIGHT</b><span class="inspect-line">${checked(inspection.lights_signals)}</span><span>MC</span></div><div class="inspect-row"><b>SIGNAL LIGHT</b><span class="inspect-line">${checked(inspection.lights_signals)}</span><span>Front</span></div><div class="inspect-row"><b>HEADLIGHT</b><span class="inspect-line">${checked(inspection.lights_signals)}</span><span>MC</span></div><div class="inspect-row"><b>BRAKES</b><span class="inspect-line">${checked(inspection.brake_system)}</span><span>Front</span></div><div class="inspect-row"><b>HORN</b><span class="inspect-line">${checked(inspection.safety_compliance)}</span><span>Loud</span></div><div class="inspect-row"><b>BODY COLOR</b><span class="inspect-line">${checked(inspection.general_cleanliness)}</span><span></span></div></div><div class="inspect-column"><div class="inspect-row"><span></span><span class="inspect-line">${checked(inspection.lights_signals)}</span><span>Side Car</span></div><div class="inspect-row"><span></span><span class="inspect-line">${checked(inspection.lights_signals)}</span><span>Rear</span></div><div class="inspect-row"><span></span><span class="inspect-line">${checked(inspection.lights_signals)}</span><span>Side Car</span></div><div class="inspect-row"><span></span><span class="inspect-line">${checked(inspection.brake_system)}</span><span>Rear</span></div><div class="inspect-row"><span></span><span class="inspect-line">${checked(inspection.safety_compliance)}</span><span>Soft</span></div></div><div class="sidecar"><b>DESIGN AND SPECIFICATIONS OF SIDECAR</b><span class="inspect-line">${valueOrBlank(renewal.inspection_remarks)}</span></div><div class="inspector"><b>INSPECTED BY:</b><div class="inspector-line">Printed Name Over Signature</div><div class="inspector-line"><b>DATE:</b> ${formatFormDate(renewal.reviewed_at)}</div></div></section>
...
export function openPmblCertificationForm({ renewal, franchise = {} }) {
  ...
  const pmblToolbarTheme =
    ".toolbar{background:#0d4778!important}.toolbar .save{background:#f4c430!important;color:#0d4778!important}.toolbar .print{color:#0d4778!important}";
