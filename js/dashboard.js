...
function renderViolations(violations) {
  ...
  new Chart(document.getElementById("violationsChart"), { type: "pie", data: { labels: labels.length ? labels : ["No violations recorded"], datasets: [{ data: labels.length ? Object.values(counts) : [1], backgroundColor: labels.length ? ["#1d4ed8", "#16a34a", "#f59e0b", "#dc2626", "#7c3aed"] : ["#cbd5e1"] }] } });
}
